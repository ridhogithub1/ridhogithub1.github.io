...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="<?php echo base_url('assets/')?>images/logos/NOSA_N.png" />
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?= site_url('User/report');?>" aria-expanded="false">
               
                <span class="hide-menu">Kelola Report</span>
              </a>
            </li>
