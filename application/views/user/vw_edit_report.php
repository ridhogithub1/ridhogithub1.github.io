        ...
        <div class="col-lg-8 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Edit Report</h5>
                    ...
                    <form action="<?= site_url('user/edit_report/' . $report['id']); ?>"" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" required value="<?= $report['location']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="department" name="department" required value="<?= $report['department']; ?>">
                                </div>

                                <!-- Lomba Kegiatan -->
                                <div class="mb-3">
                                    <label for="kegiatan" class="form-label">Kegiatan</label>
                                    <input type="text" class="form-control" id="kegiatan" name="kegiatan" required value="<?= $report['kegiatan']; ?>">
                                </div>

                                <!-- Lomba Kontraktor -->
                                <div class="mb-3">
                                    <label for="kontraktor" class="form-label">Kontraktor</label>
                                    <input type="text" class="form-control" id="kontraktor" name="kontraktor" required value="<?= $report['kontraktor']; ?>">
                                </div>

                                <!-- Lomba Inspector/Pelapor -->
                                <div class="mb-3">
                                    <label for="inspector" class="form-label">Inspector/Pelapor</label>
                                    <input type="text" class="form-control" id="inspector" name="inspector" required value="<?= $report['inspector']; ?>">
                                </div>

                                <!-- Lomba Jenis Pelanggaran Nosa -->
                                <div class="mb-3">
                                    <label for="jenis_pelanggaran_nosa" class="form-label">Jenis Pelanggaran Nosa</label>
                                    <input type="text" class="form-control" id="jenis_pelanggaran_nosa" name="jenis_pelanggaran_nosa" required value="<?= $report['jenis_pelanggaran_nosa']; ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pengawas" name="pengawas" required value="<?= $report['pengawas']; ?>">
                                </div>

                                <!-- Lomba Action Plan -->
                                <div class="mb-3">
                                    <label for="action_plan" class="form-label">Action Plan</label>
                                    <input type="text" class="form-control" id="action_plan" name="action_plan"  required value="<?= $report['action_plan']; ?>">
                                </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik" required value="<?= $report['nik']; ?>">
                                </div>
