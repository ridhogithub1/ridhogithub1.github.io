<div class="container-fluid">
  ...
  <ul class="navbar-nav flex-row ms-auto align-items-center">
    <li class="navbar-btn">
      <a target="_blank" href="<?= site_url('User/tambah_report'); ?>" class="btn btn-primary">Create Nosa Report </a>
    </li>
    <li class="navbar-btn">
      <a target="_blank" href="<?= base_url('user/excel'); ?>" class="btn btn-warning">Export Excel</a>
    </li>
  </ul>
  <div class="card ">
    <div class="card-body ">
      <h5 class="card-title fw-semibold mb-4">Kelola Report</h5>
          ...
          <tbody>
            ...
            <?php foreach ($report as $l) : ?>
              <tr>
                ...
                <td class="border-bottom-0">
                  <p class="mb-0 fw-normal"><img width="110%" src="<?= base_url().'gambar/'. $l['gambar']; ?>" alt=""></p>
                </td>
                <td class="border-bottom-0">
                ...
                <td class="border-bottom-0">
                  <span><a class="badge bg-primary rounded-3 fw-semibold" href=" <?= base_url('User/edit_report/') . $l['id'];  ?>">Edit</a></span>
                  <span><a class="badge bg-danger rounded-3 fw-semibold" href="<?= base_url('User/hapus_report/') . $l['id']; ?>">Hapus</a></span>
                </td>
                <td class="border-bottom-0">
                  <!-- harus pakai / -->
